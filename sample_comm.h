...
#define IN_HEIGHT 800
#define CROP_X (0)
#define CROP_Y (40)
#define CROP_WIDTH (IN_WIDTH-CROP_X*2)
#define CROP_HEIGHT (IN_HEIGHT-CROP_Y*2)

#define OUT_WIDTH FHD_WIDTH
#define OUT_HEIGHT FHD_HEIGHT
...
typedef enum {
    ...
    SONY_IMX415_MIPI_8M_30FPS_10BIT,
    GST_412C_SLAVE_THERMO_T3_384_288_30FPS_14BIT,
    SC2337P_MIPI_2M_25FPS_10BIT,
    SNS_TYPE_BUTT,
} sample_sns_type;
...
#ifdef VO_CUSTOM_SUPPORT
td_u32 sample_comm_start_vo_custom();
td_u32 sample_comm_stop_vo_custom();

td_s32 sample_comm_vo_start_vo_custom(const sample_vo_cfg *vo_config);
td_s32 sample_comm_vo_stop_vo_custom(const sample_vo_cfg *vo_config);

td_s32 set_gpio_out_value(td_s32 gpio_pin, td_s32 value);
#endif
#ifdef __cplusplus
}
#endif /* end of #ifdef __cplusplus */
